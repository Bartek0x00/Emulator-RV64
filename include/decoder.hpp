...
namespace Emulator {	
	...
	public:
		...
		{
			return (SCAST<int32_t>(insn & 0xfff00000U) >> 20U);
		}

		inline uint64_t imm_s(void) const
		{
			return (SCAST<int32_t>(insn & 0xfe000000U) >> 20U) | ((insn >> 7) & 0x1fU);
		}

		inline uint64_t imm_b(void) const
		{
			return (SCAST<int32_t>(insn & 0x80000000U) >> 19U) |
				((insn & 0x80U) << 4U) | 
				((insn >> 20U) & 0x7e0U) |
				((insn >> 7U) & 0x1eU);  
		}
		...
		{
			return UCAST<int32_t>(insn & 0xfffff999U);
		}

		inline uint64_t imm_j(void) const
		{
			return (SCAST<int32_t>(insn & 0x80000000U) >> 11U) |
				(insn & 0xff000U) |
				((insn >> 9U) & 0x800U) |
				((insn >> 20U) & 0x7feU);
		}
		...
		{
			return SCAST<int32_t>(insn) >> 20;
		}

		inline uint64_t fs_off(void) const
		{
			return (fl_off() & 0xfe0U) | ((insn >> 7U) & 0x1fU);
		}
		...
		inline std::string_view get_name(void) const
		{
			if (size() == 2)
				return "COMPRESSED";

			switch (opcode()) {
			case OpcodeType::LD: 		return "LOAD";
			case OpcodeType::FENCE: 	return "FENCE";
			case OpcodeType::AUIPC: 	return "AUIPC";
			case OpcodeType::LUI: 		return "LUI";
			case OpcodeType::JALR: 		return "JALR";
			case OpcodeType::JAL: 		return "JAL";
			case OpcodeType::I: 		return "IMM";
			case OpcodeType::ST: 		return "STORE";
			case OpcodeType::R: 		return "REGISTER";
			case OpcodeType::B: 		return "BRANCH";
			case OpcodeType::FL: 		return "FLT";
			case OpcodeType::FS: 		return "FLTS";
			...
			case OpcodeType::FOTHER:	return "FOTHER";
			case OpcodeType::I64: 		return "I64";
			case OpcodeType::R64: 		return "R64";
			case OpcodeType::CSR: 		return "CSR";
			case OpcodeType::ATOMIC:	return "ATOMIC";
